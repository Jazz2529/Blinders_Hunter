      ...
      child: AnimatedContainer(
        ...
        child: ClipRRect(
          ...
          child: Stack(children: [
            ...
            // Nautilus : terrain submergé — teinte bleutée sur toute la
            // tuile + badge vague, pour signaler clairement le danger
            // (3 dégâts à quiconque s'y aventure) sans pour autant
            // masquer les informations normales de la zone.
            if (isEngulfed) ...[
              Positioned.fill(
                child: IgnorePointer(
                  child: Container(
