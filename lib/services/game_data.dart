...
const List<CharacterCard> kAllCharacters = [
  ...
  CharacterCard(id:'luc', name:'Luc', faction:Faction.shadow, hp:11, icon:'🔥',
    ability:'Unique: mettez le feu à un joueur de votre choix — il brûle et subit des blessures croissantes au début de chacun de ses tours (1 → 2 → 3 → 4 → 5 → 6...), sans limite, tant que VOUS êtes en vie. Le feu s\'éteint dès que vous mourez.',
    abilityEffect:'luc_ignite',
    winCondition:'Tous les Hunters sont morts', winEffect:'shadows_win'),
  ...
  CharacterCard(id:'jason', name:'Jason', faction:Faction.neutral, hp:12, icon:'🦎',
    ...
    winCondition:'Être en vie à la fin de la partie — victoire EXCLUSIVE : si Jason est vivant à la fin, il gagne seul et tous les autres joueurs perdent',
    winEffect:'survive_solo_win'),
  ...
  CharacterCard(id:'leo', name:'Léo', faction:Faction.neutral, hp:12, icon:'💀',
    ...
    winCondition:'Être le premier à mourir', winEffect:'die_first_only'),
