...
const List<CosmeticItem> kCosmeticsCatalog = [
  ...
  CosmeticItem(id: 'hong-animal', name: 'Hong Yi - Blomburrow',
    category: CosmeticCategory.character, targetId: 'hong_yi', cost: 200,
    imagePath: 'assets/images/characters/hong-animal.png'),
  CosmeticItem(id: '-animal', name: 'Damien - Blomburrow',
    category: CosmeticCategory.character, targetId: 'damien', cost: 150,
    imagePath: 'assets/images/characters/damien-animal.png'),
  CosmeticItem(id: 'emilien-animal', name: 'Emilien - Blomburrow',
  ...
  CosmeticItem(id: 'julien-animal', name: 'Julien - Bloomburrow',
  ...
  CosmeticItem(id: 'louise-animal', name: 'Louise - Blomburrow',
    category: CosmeticCategory.character, targetId: 'louise', cost: 200,
